...
var convertToDataAttributeName = function convertToDataAttributeName(property) {
  ...
  return namespace ? "data-".concat(decamelize(namespace, '-'), "-").concat(decamelize(property, '-')) : "data-".concat(decamelize(property, '-'));
};
...
var animateScrollTo = animatedScrollTo;
...
var getAnchorSelector = function getAnchorSelector(targetId) {
  var hash = "#".concat(targetId);
  return "a[href=\"".concat(hash, "\"], a[href=\"").concat(getBaseUrl()).concat(hash, "\"]");
};
...
var getElementsArray = function getElementsArray(selector) {
...
var createInstance = function createInstance(system, componentRoot) {
  ...
  var open = function open() {
    if (!state.active) {
      system.getComponentInstances(DIALOG_COMPONENT_NAME).forEach(function (instance) {
        instance.close();
      });
...
var TABS_COMPONENT_NAME = 'tabs';

var createInstance$1 = function createInstance(system, componentRoot, _ref) {
  var _ref$tabContainerSele = _ref.tabContainerSelector,
      tabContainerSelector = _ref$tabContainerSele === void 0 ? '[data-tab-container]' : _ref$tabContainerSele,
      _ref$tabContainerActi = _ref.tabContainerActiveClass,
      tabContainerActiveClass = _ref$tabContainerActi === void 0 ? 'active' : _ref$tabContainerActi,
      _ref$tabTriggerSelect = _ref.tabTriggerSelector,
      tabTriggerSelector = _ref$tabTriggerSelect === void 0 ? 'a[href^="#"],[data-trigger-component="tabs"]' : _ref$tabTriggerSelect,
      _ref$tabTriggerActive = _ref.tabTriggerActiveClass,
      tabTriggerActiveClass = _ref$tabTriggerActive === void 0 ? 'active' : _ref$tabTriggerActive;
  var tabContainers = getElementsArray(tabContainerSelector, componentRoot);
  var tabTriggers = getElementsArray(tabTriggerSelector, componentRoot);

  var activateTab = function activateTab(tabId) {
    tabContainers.forEach(function (element) {
      element.classList.toggle(tabContainerActiveClass, element.getAttribute('id') === tabId);
    });
    var targetTabHash = "#".concat(tabId);
    tabTriggers.forEach(function (element) {
      element.classList.toggle(tabTriggerActiveClass, element.getAttribute('href') === targetTabHash || element.getAttribute('data-trigger-target') === targetTabHash);
    });
  };

  return {
    defaultAction: function defaultAction(targetElement) {
...
var createInstance$2 = function createInstance(system, componentRoot, _ref) {
...
function assignInDefaults(objValue, srcValue, key, object) {
  if (objValue === undefined ||
      (eq(objValue, objectProto[key]) && !hasOwnProperty$1.call(object, key))) {
    return srcValue;
  }
  return objValue;
}
...
var computeRelatedElementsSelector = function computeRelatedElementsSelector(baseSelector, id) {
  if (baseSelector && id) {
    return "".concat(baseSelector, ", ").concat(getAnchorSelector(id));
...
var createInstance$3 = function createInstance(options, system, componentRoot, props) {
  var _defaults = lodash_defaults(props, options, DEFAULTS),
      onProgress = _defaults.onProgress,
      onEnter = _defaults.onEnter,
      onLeave = _defaults.onLeave,
      activeClass = _defaults.activeClass,
      enterClass = _defaults.enterClass,
      focusClass = _defaults.focusClass,
      leaveClass = _defaults.leaveClass,
      topBoundary = _defaults.topBoundary,
      bottomBoundary = _defaults.bottomBoundary,
  ...
  var componentIdAttribute = componentRoot.getAttribute('id');
  var relatedElementsSelector = computeRelatedElementsSelector(related, componentIdAttribute);
  var relatedElements = relatedElementsSelector ? getElementsArray(relatedElementsSelector, system.rootElement) : [];
  /**
  ...
  var enter = function enter() {
    if (!instance.isActive) {
      ...
      onEnter(instance, instance.progress > instance.previousProgress ? 1 : -1);
    }
  };
  /**
  ...
  var leave = function leave() {
    if (instance.isActive) {
      ...
      onLeave(instance, instance.progress > instance.previousProgress ? 1 : -1);
    }
  };
  ...
  var handleProgress = function handleProgress(progress) {
    if (progress !== instance.progress) {
      ...
      onProgress(instance, instance.progress, instance.progress > instance.previousProgress ? 1 : -1, instance.previousProgress);
    }
  };
  /**
  ...
  var activateFocus = function activateFocus() {
  ...
  var deactivateFocus = function deactivateFocus() {
    if (instance.isFocused) {
  ...
  var scrollIntoFocus = function scrollIntoFocus() {
  ...
  return Object.assign(instance, {
    ...
    deactivateFocus: deactivateFocus,
    scrollIntoFocus: scrollIntoFocus,
    defaultAction: defaultAction
  });
};
var instancePropTypes = {
  activeClass: propTypes.string,
...
var SCROLL_TARGET_COMPONENT_NAME = 'scroll-target';
/**
 * Initializes
 */

var initialize = function initialize(_ref, system) {
  var _ref$onProgress = _ref.onProgress,
      _ref$onEnter = _ref.onEnter,
      _ref$onLeave = _ref.onLeave;
  var WINDOW_INNER_HEIGHT;

  var updateWindowMeasures = function updateWindowMeasures() {
    WINDOW_INNER_HEIGHT = window.innerHeight;
  };

  var updateScrollData = function updateScrollData() {
    system.getComponentInstances(SCROLL_TARGET_COMPONENT_NAME).forEach(function (instance, index) {
      var element = instance.element,
          activeClass = instance.activeClass,
          topBoundary = instance.topBoundary,
          bottomBoundary = instance.bottomBoundary,
          focusPosition = instance.focusPosition,
          preventLeave = instance.preventLeave,
          enter = instance.enter,
          leave = instance.leave,
          handleProgress = instance.handleProgress,
          activateFocus = instance.activateFocus,
          deactivateFocus = instance.deactivateFocus;
      ...
      var _topBoundary = WINDOW_INNER_HEIGHT - topBoundary * WINDOW_INNER_HEIGHT;

      var _bottomBoundary = 0 + bottomBoundary * WINDOW_INNER_HEIGHT;

      var _focusPosition = focusPosition * WINDOW_INNER_HEIGHT;

      var _coveredDistance = Math.max(_topBoundary - top, 0);

      var _totalDistance = bottom - top + (_topBoundary - _bottomBoundary);

      var _progress = Math.min(_coveredDistance / _totalDistance, 1);
...
var scrollTarget = (function (options) {
  return {
    ...
    createInstance: createInstance$3.bind(null, options),
    instancePropTypes: instancePropTypes
  };
});
